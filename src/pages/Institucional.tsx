...
import { Users, Target, Heart, Lightbulb, Wrench, TrendingUp, Sparkles, Brain } from "lucide-react";
  ...
  const values = [
    {
      ...
      name: "Autenticidade",
      description:
        "Honramos a identidade e a história de cada mulher, promovendo um posicionamento verdadeiro, coerente e alinhado ao seu propósito.",
    },
    {
      icon: Target,
      name: "Lealdade",
    ...
    },
    {
      ...
      name: "Proatividade",
      description:
        "Estimulamos a autoliderança, a iniciativa e a criação de soluções que geram impacto real e sustentável.",
    },
    {
      icon: TrendingUp,
      name: "Crescimento",
      description:
        "Cultivamos a evolução contínua por meio do aprendizado, da consciência e da expansão pessoal e profissional.",
    },
  ];
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-primary-700 text-lg mb-4">
                ...
                mercado: onde estavam, como se sentiam e de que forma se capacitavam para crescer profissionalmente. A
                partir dessa inquietação, foi criado um grupo de WhatsApp com 14 mulheres, dando início a um movimento
                de escuta, troca e fortalecimento feminino no sul do país, inicialmente conhecido como Gaúchas Car.
              </p>
              <p className="text-primary-700 text-lg">
                Com o crescimento orgânico da iniciativa e o reconhecimento das indústrias e empresas do setor
                automotivo, o movimento ganhou dimensão nacional, evoluindo para o Instituto Mulheres V8. Hoje, o MV8 é
                um ecossistema estruturado de desenvolvimento feminino que integra educação técnica, gestão de negócios,
                desenvolvimento humano e espiritualidade, mantendo sua essência de origem enquanto atua de forma
                estratégica para ampliar a representatividade, a capacitação e o protagonismo das mulheres em toda a
                cadeia automotiva.
              </p>
            </div>
      ...
      <section className="py-16 px-4 bg-brand-yellow">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-black mb-4">
            Faça parte da principal comunidade de mulheres do setor automotivo.
          </h2>
